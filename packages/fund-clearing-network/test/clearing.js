...
describe('Fund Clearing Network', () => {
    ...
    describe('Network Operation', () => {
        ...
        beforeEach(async () => {
            ...
            batch0.parties = [factory.newRelationship(namespace, 'BankingParticipant', namespace + '.BankingParticipant#' + bank0), factory.newRelationship(namespace, 'BankingParticipant', namespace + '.BankingParticipant#' + bank1)];
            ...
            batch1.parties = [factory.newRelationship(namespace, 'BankingParticipant', namespace + '.BankingParticipant#' + bank1), factory.newRelationship(namespace, 'BankingParticipant', namespace + '.BankingParticipant#' + bank2)];
            ...
            batch2.parties = [factory.newRelationship(namespace, 'BankingParticipant', namespace + '.BankingParticipant#' + bank1), factory.newRelationship(namespace, 'BankingParticipant', namespace + '.BankingParticipant#' + bank2)];
        ...
        describe('Asset Access', () => {
            ...
            it('should permit a Participant to read BatchTransferRequest(s) if the Participant is identified within the `parties` array', async () => {
                // Use the identity for Bank1 and bank2.
                await useIdentity(bank0);
        ...
        describe('Transaction Access', () => {
            ...
            it('should prevent a Participant not identified within the `parties` array from invoking a `MarkPreProcessComplete` transaction for a passed batch reference', async () => {
                ...
                await useIdentity(bank3);
                await businessNetworkConnection.submitTransaction(transaction).should.be.rejectedWith(/does not have .* access to resource/);
            });
